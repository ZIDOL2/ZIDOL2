...
- 회원가입, 로그인, 커뮤니티게시판(공지사항/자유게시판) front 및 back 담당 (진행률100%)  
  ([Personal_pet_mate](https://github.com/ZIDOL2/personal_pet_mate.git) / main2브런치 > Personal_Pet_Mate/src/main (깃허브 공부 중..))    

**[tinyFarm]** : 도시농부를 꿈꾸는 사람들에게 텃밭 정보와 영농일지 작성 서비스를 제공하는 사이트  
  - 마이페이지 기능구현 담당 (회원관리/영농일지/활동내역/거래내역)  
  - 회원간 친목을 위한 상대회원의 정보를 보는 기능 구현 담당  
    [진행률(90%) 아직 개발중이므로 오류가 발생할 수 있음] ([tinyFarm](https://github.com/ZIDOL2/tinyFarm))
